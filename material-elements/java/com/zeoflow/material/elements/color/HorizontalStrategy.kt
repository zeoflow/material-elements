...
internal class HorizontalStrategy : OrientationStrategy {
  ...
  override fun measure(view: ColorSeekBar, widthSpec: Int, heightSpec: Int): Rect {
  ...
  override fun calculateGradientBounds(view: ColorSeekBar): Rect {
  ...
  override fun calculateThumbCoordinates(view: ColorSeekBar, barBounds: Rect): PointF {
    val x = (barBounds.left + view.offset * barBounds.width())
    val y = view.height / 2f
    return point.apply { set(x, y) }
  }

  override fun calculateOffsetOnMotionEvent(view: ColorSeekBar, event: MotionEvent, barBounds: Rect): Float {
