...
import static com.zeoflow.material.elements.bottomsheet.utils.Extensions.changeNavigationIconColor;
import static com.zeoflow.material.elements.bottomsheet.utils.Extensions.changeStatusBarIconColor;
...
public class BottomDrawer extends FrameLayout
{
    ...
    public void onSlide(float value)
    {
        ...
        autoSetStatusBarColor(value);
        invalidate();
    }
    public void autoSetStatusBarColor(float value)
    {
        if (autoStatusBarColor)
        {
            if (value > 0.975f)
            {
                if (!darkHigh)
                {
                    darkHigh = true;
                    darkLow = false;
                    changeStatusBarIconColor(isColorDark(drawerBackground), dialogFragment);
                    changeNavigationIconColor(isColorDark(drawerBackground), dialogFragment);
                }
            } else
            {
                if (!darkLow)
    ...
    private boolean darkLow = false;
    private boolean darkHigh = false;
    ...
    public void setAutoStatusBar(boolean autoStatusBarColor, DialogFragment dialogFragment)
    {
        this.autoStatusBarColor = autoStatusBarColor;
