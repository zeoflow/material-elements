...
public class ScrollingPagerIndicator extends View
{
  ...
  protected void onDraw(Canvas canvas)
  {
    ...
    float scaleDistance = (spaceBetweenDotCenters + ((dotSelectedSize - dotNormalSize) >> 1)) * 0.7f;
    float smallScaleDistance = dotSelectedSize >> 1;
  ...
  private void initDots(int itemCount)
  {
    ...
    firstDotOffset = !looped || this.itemCount <= visibleDotCount ? dotSelectedSize / 2 : 0;
