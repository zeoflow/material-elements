...
final class IndicatorViewController
{
    ...
    @NonNull
    private final OutlinedLayout textInputView;
    ...
    public IndicatorViewController(@NonNull OutlinedLayout textInputView)
    {
        ...
        boolean animate)
    {
        ...
        textInputView.updateLabelState();
    ...
    void adjustIndicatorPadding()
    {
        if (canAdjustIndicatorPadding())
        {
            ...
            ViewCompat.setPaddingRelative(
                indicatorArea,
                ViewCompat.getPaddingStart(textInputView.getLinearLayout()),
                0,
                ViewCompat.getPaddingEnd(textInputView.getLinearLayout()),
                0);
        }
    }
    ...
    {
        return indicatorArea != null && textInputView.getLinearLayout() != null;
    }
    ...
    void addIndicator(TextView indicator, @IndicatorIndex int index)
    {
        if (indicatorArea == null && captionArea == null)
        {
            ...
            if (textInputView.getLinearLayout() != null)
            {
