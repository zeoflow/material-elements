...
import static com.zeoflow.material.elements.viewpager.MaterialViewPager.SCROLL_STATE_DRAGGING;
import static com.zeoflow.material.elements.viewpager.MaterialViewPager.SCROLL_STATE_IDLE;
import static com.zeoflow.material.elements.viewpager.MaterialViewPager.SCROLL_STATE_SETTLING;
import static com.zeoflow.material.elements.viewpager.MaterialViewPager.ScrollState;
 ...
 * for {@link MaterialViewPager}. As part of this process, it keeps track of the current scroll position
...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private @MaterialViewPager.ScrollState int mScrollState;
    ...
    ScrollEventAdapter(@NonNull MaterialViewPager viewPager) {
    ...
    private void startDrag(boolean isFakeDrag) {
        ...
        if (mTarget != NO_POSITION) {
            ...
            // Update "drag start page" to reflect the page that MaterialViewPager thinks it is at
            mDragStartPosition = mTarget;
            // Reset target because drags have no target until released
            mTarget = NO_POSITION;
        } else if (mDragStartPosition == NO_POSITION) {
            // MaterialViewPager was at rest, set "drag start page" to current page
    ...
    /**
     * @return {@code true} if the MaterialViewPager is being dragged. Returns {@code false} from the
     *         moment the MaterialViewPager starts settling or goes idle.
     */
    boolean isDragging() {
     ...
     *         {@link MaterialViewPager#endFakeDrag()} is called.
     */
     ...
     * the ViewPager is settling towards its {@link MaterialViewPager#getCurrentItem() current item}, or
