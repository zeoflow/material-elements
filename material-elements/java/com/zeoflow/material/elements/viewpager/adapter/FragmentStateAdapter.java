...
package com.zeoflow.material.elements.viewpager.adapter;

import static androidx.core.util.Preconditions.checkArgument;
import static androidx.lifecycle.Lifecycle.State.RESUMED;
import static androidx.lifecycle.Lifecycle.State.STARTED;
import static androidx.recyclerview.widget.RecyclerView.NO_ID;
import static com.zeoflow.material.elements.viewpager.adapter.FragmentStateAdapter.FragmentTransactionCallback.OnPostEventListener;
...
public abstract class FragmentStateAdapter extends
    ...
    /**
     * @param fragmentActivity if the {@link MaterialViewPager} lives directly in a
    ...
    /**
     * @param fragment if the {@link MaterialViewPager} lives directly in a {@link Fragment} subclass.
     *
    ...
    /**
     * @param fragmentManager of {@link MaterialViewPager}'s host
     * @param lifecycle of {@link MaterialViewPager}'s host
     *
     * @see FragmentStateAdapter#FragmentStateAdapter(FragmentActivity)
     * @see FragmentStateAdapter#FragmentStateAdapter(Fragment)
     */
     ...
     * </ul>
     * @see MaterialViewPager#setOffscreenPageLimit
     */
    ...
    public final void restoreState(@NonNull Parcelable savedState) {
        ...
        if (bundle.getClassLoader() == null) {
            /** TODO(b/133752041): pass the class loader from {@link MaterialViewPager.SavedState } */
    ...
    class FragmentMaxLifecycleEnforcer {
        private MaterialViewPager.OnPageChangeCallback mPageChangeCallback;
        ...
        void register(@NonNull RecyclerView recyclerView) {
            ...
            mPageChangeCallback = new MaterialViewPager.OnPageChangeCallback() {
                @Override
        ...
        void unregister(@NonNull RecyclerView recyclerView) {
            MaterialViewPager viewPager = inferViewPager(recyclerView);
        ...
        void updateFragmentMaxLifecycle(boolean dataSetChanged) {
            ...
            if (mViewPager.getScrollState() != MaterialViewPager.SCROLL_STATE_IDLE) {
            ...
            if (currentItem >= getItemCount()) {
                 ...
                 * notified via {@link MaterialViewPager.OnPageChangeCallback#onPageSelected(int)}  */
                return;
            }
        ...
        @NonNull
        private MaterialViewPager inferViewPager(@NonNull RecyclerView recyclerView) {
            ViewParent parent = recyclerView.getParent();
            if (parent instanceof MaterialViewPager) {
                return (MaterialViewPager) parent;
            }
            throw new IllegalStateException("Expected MaterialViewPager instance. Got: " + parent);
        }
    }
