...
import com.zeoflow.material.elements.viewpager.adapter.StatefulAdapter;
 ...
 * MaterialViewPager
 */
public class MaterialViewPager extends ViewGroup {
    /** @hide */
    ...
    /**
     * Indicates that the MaterialViewPager is in an idle, settled state. The current page
     * is fully in view and no animation is in progress.
     */
    public static final int SCROLL_STATE_IDLE = 0;

    /**
     * Indicates that the MaterialViewPager is currently being dragged by the user, or programmatically
     * via fake drag functionality.
     */
    public static final int SCROLL_STATE_DRAGGING = 1;

    /**
     * Indicates that the MaterialViewPager is in the process of settling to a final position.
     */
    ...
    public MaterialViewPager(@NonNull Context context) {
        super(context);
        initialize(context, null);
    }

    public MaterialViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs);
    }

    public MaterialViewPager(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * A lot of places in code rely on an assumption that the page fills the whole MaterialViewPager.
     *
            ...
            public void onChildViewAttachedToWindow(@NonNull View view) {
                ...
                if (layoutParams.width != LayoutParams.MATCH_PARENT
                    ...
                    throw new IllegalStateException(
                            "Pages must fill the whole MaterialViewPager (use match_parent)");
                }
            }
    ...
    private void setOrientation(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MaterialViewPager);
        ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.MaterialViewPager, attrs,
                a, 0, 0);
        try {
            setOrientation(
                    a.getInt(R.styleable.MaterialViewPager_android_orientation, ORIENTATION_HORIZONTAL));
        } finally {
            a.recycle();
        }
    }
    ...
    protected void dispatchRestoreInstanceState(SparseArray<Parcelable> container) {
        ...
        // State of MaterialViewPager and its child (RecyclerView) has been restored now
        restorePendingState();
    }
    ...
    /**
     * Sets the orientation of the MaterialViewPager.
     *
    ...
    public void setCurrentItem(int item, boolean smoothScroll) {
        if (isFakeDragging()) {
            throw new IllegalStateException("Cannot change current item when MaterialViewPager is fake "
                    + "dragging");
        }
    ...
    /**
     * Returns the current scroll state of the MaterialViewPager. Returned value is one of can be one of
     ...
     *
     * <p>A fake drag can be useful if you want to synchronize the motion of the MaterialViewPager with the
     * touch scrolling of another view, while still letting the MaterialViewPager control the snapping
     ...
     * calling {@code beginFakeDrag}. If you need the MaterialViewPager to ignore touch events and other
     ...
     * the MaterialViewPager's orientation is horizontal, then the behavior will be inverted. This matches
    ...
    /**
     * Snaps the MaterialViewPager to the closest page
     */
    void snapToPage() {
     ...
     *
     * @return {@code true} if users can scroll the MaterialViewPager, {@code false} otherwise
    ...
    public WindowInsets onApplyWindowInsets(@NonNull WindowInsets insets) {
        // First let the MaterialViewPager itself try and consume them...
        final WindowInsets applied = super.onApplyWindowInsets(insets);
        if (applied.isConsumed()) {
            // If the MaterialViewPager consumed all insets, return now
            return applied;
        }

        // Now we'll manually dispatch the insets to our children. Since MaterialViewPager
        ...
        // platform from dispatching the insets to MaterialViewPager's children, because the platform's
    ...
    /**
     * Add an {@link ItemDecoration} to this MaterialViewPager. Item decorations can
    ...
    /**
     * Returns an {@link ItemDecoration} previously added to this MaterialViewPager.
     *
    ...
    /**
     * Returns the number of {@link ItemDecoration} currently added to this MaterialViewPager.
     *
     * @return number of ItemDecorations currently added added to this MaterialViewPager.
     */
    ...
    /**
     * Invalidates all ItemDecorations. If MaterialViewPager has item decorations, calling this method
    ...
    /**
     * Remove an {@link ItemDecoration} from this MaterialViewPager.
     *
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        private final AccessibilityViewCommand mActionPageForward =
                new AccessibilityViewCommand() {
                    ...
                    public boolean perform(@NonNull View view,
                        ...
                        MaterialViewPager viewPager = (MaterialViewPager) view;
        ...
        public void onInitialize(@NonNull CompositeOnPageChangeCallback pageChangeEventDispatcher,
            ...
            if (ViewCompat.getImportantForAccessibility(MaterialViewPager.this)
                    == ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
                ViewCompat.setImportantForAccessibility(MaterialViewPager.this,
        ...
        public void onRvInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
            event.setSource(MaterialViewPager.this);
        ...
        /**
         * Update the MaterialViewPager's available page accessibility actions. These are updated in
         * response to page, adapter, and orientation changes. Compatible with API >= 21.
         */
        void updatePageAccessibilityActions() {
            MaterialViewPager viewPager = MaterialViewPager.this;
