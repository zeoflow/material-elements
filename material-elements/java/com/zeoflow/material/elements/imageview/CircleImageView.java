...
public class CircleImageView extends ShapeableImageView
{
  ...
  public CircleImageView(Context context, AttributeSet attrs, int defStyle)
  {
    ...
    mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_borderWidthCIV, DEFAULT_BORDER_WIDTH);
    mBorderColor = a.getColor(R.styleable.CircleImageView_borderColorCIV, DEFAULT_BORDER_COLOR);
    mBorderOverlay = a.getBoolean(R.styleable.CircleImageView_borderOverlayCIV, DEFAULT_BORDER_OVERLAY);
    mCircleBackgroundColor = a.getColor(R.styleable.CircleImageView_circleBackgroundColor, DEFAULT_CIRCLE_BACKGROUND_COLOR);
